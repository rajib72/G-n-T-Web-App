            ...
            <div className="bg-white p-3 rounded w-25">
                ...
                <form action="" onSubmit={handleSubmit}>
                    <div className='mb-3'>
                        ...
                        <input type="text" placeholder='Enter Name' autoComplete='off' name='email' className='form-control rounded-0' onChange={(e)=>{
                ...
                <Link to="/" className='btn btn-default border w-100 bg-light rounded-o text-decoreation-none'>Login</Link>
